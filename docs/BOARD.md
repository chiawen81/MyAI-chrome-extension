...
<details>
<summary>#6 [功能] Claude 助手：交棒時可指定 claude.ai 模型</summary>
...
<details>
<summary>#8 [功能] Claude 助手：整頁「請 Claude 翻譯此頁」右鍵動作？</summary>

- 動機：逛英文網站時想要整頁翻譯的右鍵入口（2026-07-11 測試回饋）。
- 待討論：與功能一（整頁雙語對照翻譯，Alt+T／popup）定位重疊——雙語對照可原地閱讀、有快取、惰性只翻視口；交棒 claude.ai 則整頁進對話、超長會截斷、回應是純文字聊天訊息。傾向以既有功能一為主，先觀察動作 4（翻譯＋摘要）是否已覆蓋需求。
...
- 編號為全域流水號，跨欄位不重複、刪除不回收；**下一個編號：#14**（新增項目後記得遞增此數字）。
